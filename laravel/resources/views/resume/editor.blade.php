    ...
    <div class="container">
        ...
        <div class="row">
            <div class="list-group col-sm-2 mt-3">
                ...
                <a href="{{ asset("editor") }}" class="list-group-item list-group-item-action active">Edit resume</a>
            ...
            <div class="col-sm-10 mt-3 ">
                <table class="table table-striped table-dark table-hover">
                    ...
                    <tr onclick="location.href='editor/workspace?createTime={{$resumeShow->created_at}}'" style="cursor: pointer;">
                        <th scope="row"><?php $number = $number +1?>{{$number}}</th>
                        <td>{{ $resumeShow->job }}</td>
                        <td><?php date_default_timezone_set('America/Los_Angeles');?>{{ date("Y-m-d H:i",$resumeShow->updated_at) }}</td>
                        <td><?php date_default_timezone_set('America/Los_Angeles');?>{{ date("Y-m-d H:i",$resumeShow->created_at) }}</td>
                    </tr>
                    @endforeach
                    </tbody>
                </table>
